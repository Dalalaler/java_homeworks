...
public class DataToGenerate {
    ...
    public static void writeReadyData() throws IOException, DataWriteException {
        String fileName = ".\\src\\main\\resources\\data.json";
        DataWriteUtil.writeInFile(fileName, DataToGenerate.task6);
        DataWriteUtil.writeInFile(fileName, DataToGenerate.task1);
        DataWriteUtil.writeInFile(fileName, DataToGenerate.task3);
        DataWriteUtil.writeInFile(fileName, DataToGenerate.task2);
        DataWriteUtil.writeInFile(fileName, DataToGenerate.task5);
        DataWriteUtil.writeInFile(fileName, DataToGenerate.task4);
    }
